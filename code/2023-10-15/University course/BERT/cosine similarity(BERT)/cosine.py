...
d = pd.read_csv(r'D:\Code\PycharmProjects\LK_project\MHAVGAE-main\2023-10-15\University course\data\cs_concept_pairs.csv', usecols=['A', 'B'])
...
df.to_excel('cosine_similarity(BERT).xlsx', index=False)
