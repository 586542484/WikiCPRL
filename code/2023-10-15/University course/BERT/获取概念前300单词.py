...
with open(r'D:\Code\PycharmProjects\LK_project\MHAVGAE-main\2023-10-15\University course\BERT\概念content保存\conceptContent.json') as read_file:
...
df.to_excel('概念前300词/words-300.xlsx')
